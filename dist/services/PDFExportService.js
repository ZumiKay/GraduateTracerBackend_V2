...
class PDFExportService {
    static async generateAnalyticsPDF(analyticsData, formTitle) {
        ...
        try {
            ...
            await page.setContent(this.generateHTMLTemplate(analyticsData, formTitle));
    ...
    static generateHTMLTemplate(data, formTitle) {
        ...
        <body>
          ...
          <div class="metrics-grid">
            ...
            <div class="metric-card">
              ...
              <div class="value">${((data.completedResponses / data.totalResponses) *
            100).toFixed(1)}%</div>
            </div>
            <div class="metric-card">
              <h3>Average Score</h3>
            ...
            .map((question) => `
                <div class="performer-item">
                  <div class="performer-info">
                    ...
                    <div class="performer-email">Accuracy: ${question.accuracy.toFixed(1)}%</div>
                  </div>
                  <div class="performer-score">${question.averageScore.toFixed(1)} avg</div>
                </div>
              `)
            .join("")}
            </div>
          ...
          <div class="section">
            ...
            .map((score) => `
                <div class="performer-item">
                  ...
                  <div class="performer-score">${score.percentage.toFixed(1)}%</div>
                </div>
              `)
            .join("")}
            </div>
...
exports.default = PDFExportService;

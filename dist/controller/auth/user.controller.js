...
function GetUserProfile(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const userProfile = yield User_model_1.default.findById(user.sub)
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (edituserdata.edittype === "name") {
                const isName = yield User_model_1.default.findOne({ name: edituserdata.name }).lean();
                if (isName) {
                    return res.status(400).json((0, helper_1.ReturnCode)(400, "Username already exist"));
                }
                yield User_model_1.default.updateOne({ _id: edituserdata._id }, { name: edituserdata.name });
            }

...
// Re-export extracted controllers for backward compatibility
...
var form_crud_controller_1 = require("./form.crud.controller");
Object.defineProperty(exports, "CreateForm", { enumerable: true, get: function () { return form_crud_controller_1.CreateForm; } });
Object.defineProperty(exports, "EditForm", { enumerable: true, get: function () { return form_crud_controller_1.EditForm; } });
Object.defineProperty(exports, "DeleteForm", { enumerable: true, get: function () { return form_crud_controller_1.DeleteForm; } });
Object.defineProperty(exports, "GetAllForm", { enumerable: true, get: function () { return form_crud_controller_1.GetAllForm; } });
var formPageService_1 = require("../services/formPageService");
Object.defineProperty(exports, "PageHandler", { enumerable: true, get: function () { return formPageService_1.PageHandler; } });
...
const ManageFormCollaborator = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const operationId = MongoErrorHandler.generateOperationId("manage_collaborator");
    try {
        ...
        const targetUser = yield User.findOne({ email }).exec();
        if (!targetUser)
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (ty === "add") {
                ...
                const toBeDeleteContent = yield Content.find({ page: deletepage })
                    .select("_id")
                    .lean();
                ...
                yield Content.deleteMany({ page: deletepage });
            }
            return res
                .status(200)
...
function handleDetailQuery(res, ty, q, p, user, page) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resultContent = yield Content.find({
        ...
        if (page && page > 1) {
            const prevPageContent = yield Content.find({
                _id: { $in: detailForm.contentIds },
                page: page - 1,
            })
                .select("qIdx")
        ...
        return res.status(200).json(Object.assign(Object.assign({}, (0, helper_1.ReturnCode)(200)), { data: Object.assign(Object.assign(Object.assign(Object.assign({}, detailForm), { contents: groupContentByParent(resultContent), contentIds: undefined, validationSummary }), accessInfo), (page &&
                page > 1 && {
...
function handleTotalQuery(res, q, user) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!accessInfo.hasAccess)
            return res.status(403).json((0, helper_1.ReturnCode)(403, "Access denied"));
        const contentStats = yield Content.aggregate([
    ...
    return __awaiter(this, arguments, void 0, function* ({ p, userId, tab, res, lt, filter, }) {
        ...
        try {
            ...
            if (tab === Form_model_1.DashboardTabType.filledform) {
                const user = yield User.findById(userId).select("email").lean();
                const filledForms = yield FormResponse.find({
                    userId: userId,
    ...
    return __awaiter(this, void 0, void 0, function* () {
        switch (tab) {
            ...
            case Form_model_1.DashboardTabType.filledform:
                ...
                const filledFormIds = yield FormResponse.distinct("formId", { userId });
                return {
...
const GetFilledForm = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        //Get User Response
        const userResponses = yield FormResponse.find({
            $and: [

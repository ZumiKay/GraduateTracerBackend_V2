...
async function AddFormContent(req, res) {
    const data = req.body;
    try {
        const AddContent = await Content_model_1.default.create(data.contents);
        const AddedContentIds = AddContent.id;
        //Assign to form
        const updateForm = await Form_model_1.default.updateOne({ _id: data.formId }, { contentIds: AddedContentIds });
...
async function EditFormContent(req, res) {
    ...
    try {
        ...
        // Update content
        const updatedContentResult = await Content_model_1.default.findByIdAndUpdate(contents._id, updatedContent, {
        ...
        const response = {
            ...(0, helper_1.ReturnCode)(200, "Content updated successfully"),
...
async function DeleteContent(req, res) {
    ...
    try {
        ...
        if (formId) {
            await Form_model_1.default.updateOne({ _id: formId }, { $pull: { contentIds: id } });
        }
...
async function ValidateFormContent(req, res) {

...
class FormResponseSubmissionController {
        ...
        try {
            ...
            if (!validationResult.isValid) {
                return res.status(400).json({
                    ...(0, helper_1.ReturnCode)(400, validationResult.message),
            ...
            try {
                ...
                if (form.type === Form_model_1.TypeForm.Quiz) {
                    result = await ResponseProcessingService_1.ResponseProcessingService.processFormSubmission(submissionDataWithTracking, form);
                }
                //Normal type process
                else {
                    result = await ResponseProcessingService_1.ResponseProcessingService.processNormalFormSubmission(submissionDataWithTracking);
                }
            }
    ...
    async GetInititalFormData(formId, res) {
        ...
        try {
            const formdata = await Form_model_1.default.findById(formId)

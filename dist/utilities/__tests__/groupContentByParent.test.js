...
describe("groupContentByParent", () => {
    ...
    test("should correctly handle multiple nested levels with mixed parent relationships", () => {
                ...
                conditional: [
                    {
                        ...
                        key: 0,
                        contentId: new mongoose_1.Types.ObjectId("000000000000000000000001"),
                    },
                    {
                        _id: new mongoose_1.Types.ObjectId(),
                        key: 1,
                        contentId: new mongoose_1.Types.ObjectId("000000000000000000000002"),
                    },
                ],
            },
            {
                ...
                type: Content_model_1.QuestionType.Text, // Changed from Radio to Text since Radio isn't in the enum
                conditional: [
                    {
                        _id: new mongoose_1.Types.ObjectId(),
                        key: 0,
                        contentId: new mongoose_1.Types.ObjectId("000000000000000000000003"),
                    },
                ],
            },
                ...
                conditional: [
                    {
                        _id: new mongoose_1.Types.ObjectId(),
                        key: 0,
                        contentId: new mongoose_1.Types.ObjectId("000000000000000000000004"),
                    },
                    {
                        _id: new mongoose_1.Types.ObjectId(),
                        key: 1,
                        contentId: new mongoose_1.Types.ObjectId("000000000000000000000005"),
                    },
                ],
            },
            {
                ...
                conditional: [
                    {
                        _id: new mongoose_1.Types.ObjectId(),
                        key: 0,
                        contentId: new mongoose_1.Types.ObjectId("000000000000000000000006"),
                    },
                    {
                        _id: new mongoose_1.Types.ObjectId(),
                        key: 1,
                        contentId: new mongoose_1.Types.ObjectId("000000000000000000000007"),
                    },
                    {
                        _id: new mongoose_1.Types.ObjectId(),
                        key: 2,
                        contentId: new mongoose_1.Types.ObjectId("000000000000000000000008"),
                    },
                ],
            },
                ...
                conditional: [
                    {
                        _id: new mongoose_1.Types.ObjectId(),
                        key: 0,
                        contentId: new mongoose_1.Types.ObjectId("000000000000000000000009"),
                    },
                ],
            },
        ...
        // Act
        const result = (0, helper_1.groupContentByParent)(mockData);
        console.log("Result IDs:", result.map((item) => item._id));
        // Assert

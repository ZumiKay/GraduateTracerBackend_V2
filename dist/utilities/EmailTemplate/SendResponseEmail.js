...
exports.generateResponseHTML = void 0;
const respondentUtils_1 = require("../respondentUtils");
const generateResponseHTML = (form, response) => {
...
exports.generateResponseHTML = generateResponseHTML;

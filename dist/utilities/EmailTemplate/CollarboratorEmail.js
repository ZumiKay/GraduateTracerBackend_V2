...
exports.generateCollaboratorInviteEmail = generateCollaboratorInviteEmail;
exports.generateOwnershipTransferEmail = generateOwnershipTransferEmail;
exports.generateCollaboratorReminderEmail = generateCollaboratorReminderEmail;
const Form_model_1 = require("../../model/Form.model");
/**
 * Generate HTML email template for collaborator invitation
 */
function generateCollaboratorInviteEmail(params) {
    const { inviterEmail, formTitle, role, inviteUrl, expiresInHours } = params;
    const roleBadgeColor = role === Form_model_1.CollaboratorType.owner ? "#059669" : "#3b82f6";
    return `
    <!DOCTYPE html>
    <html>
    <head>
 ...
 */
function generateOwnershipTransferEmail(params) {
 ...
 */
function generateCollaboratorReminderEmail(params) {
    const { inviterEmail, formTitle, role, inviteUrl, expiresInHours } = params;
    return `
    <!DOCTYPE html>
    <html>
